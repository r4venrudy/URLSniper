...
func main() {
	token := "MTI3NjQ3ODEyNDE3OTE5Mzg2MQ.GQIqfg.v4Qn7_4wt0DuHoy_qYoXRxtB2rFweRfktvHaRk"
	serverID := "1117952905614471338"
	password := "vacxzendroysyalanvcxS2MaskesipUsadfas11"
	var mfaToken string
